...
var material = Cesium.Material.fromType('Color');
    ...
    // function add(instance,viewer) {
    //     let primitive= primitives(instance)
    //     let manager= managers(viewer)
    ...
    //     }
    // }
    // function deletes(instance,viewer) {
    //     let manager= managers(viewer)
    //     let primitive= primitives(instance)
...
onMounted(() => {
    ...
    // setTimeout(function () {
    //     // instance.pop()
    //     console.log("222hou", instance);
    //     // debugger
    // }, 3000);
    // let primitive= primitives(instance)
    // viewer.scene.primitives.remove(primitive); 
    // deletes(instance,viewer)
